document.addEventListener("DOMContentLoaded", function () {
    ...
    const translations = {
        es: {
            ...
            "education.card2.title": "Sesiones y demos",
            "education.card2.text": "Pronto habilitaremos demos guiadas sobre agentes, pipelines de datos y arquitecturas en nube.",
            "education.card2.note": "Las sesiones estarán orientadas a equipos técnicos pero con lenguaje accesible a ejecutivos.",
        ...
        en: {
            ...
            "education.card2.title": "Sessions and demos",
            "education.card2.text": "We will soon enable guided demos on agents, data pipelines, and cloud architectures.",
            "education.card2.note": "Sessions will target technical teams while remaining accessible to executives.",
